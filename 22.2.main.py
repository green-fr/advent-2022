...
n = 50
maze3D = []
maze3D.append([maze2D[i][n * 1 : n * 2] for i in range(n * 0, n * 1)])
maze3D.append([maze2D[i][n * 2 : n * 3] for i in range(n * 0, n * 1)])
maze3D.append([maze2D[i][n * 1 : n * 2] for i in range(n * 1, n * 2)])
maze3D.append([maze2D[i][n * 0 : n * 1] for i in range(n * 2, n * 3)])
maze3D.append([maze2D[i][n * 1 : n * 2] for i in range(n * 2, n * 3)])
maze3D.append([maze2D[i][n * 0 : n * 1] for i in range(n * 3, n * 4)])
...
def unfoldPosition(position):
    if (position.layer == 0):
        return (1 * n + position.x, 0 * n + position.y)
        ...
        return (0 * n + position.x, 2 * n + position.y)
    elif (position.layer == 4):
        return (1 * n + position.x, 2 * n + position.y)
    elif (position.layer == 5):
        return (0 * n + position.x, 3 * n + position.y)
